...
namespace Infrastructure.Repositories
{
    public class AuctionRepository : IAuctionRepository
    {
        ...
        public async Task AgregarAsync(
            ...
            CancellationToken cancellationToken)
        {
            await _context.Subastas.AddAsync(
                subasta,
                cancellationToken);
        }

        public async Task<Auction?> ObtenerPorIdAsync(
            int id,
            CancellationToken cancellationToken)
        {
            return await _context.Subastas
        ...
        public async Task<IList<Auction>> ObtenerPorVendedorIdAsync(
            int vendedorId,
            CancellationToken cancellationToken)
        {
            return await _context.Subastas
        ...
        public async Task<Auction?> ObtenerPorIdParaActualizarAsync(
            int id,
            CancellationToken cancellationToken)
        {
            return await _context.Subastas
        ...
        public async Task<IList<Auction>> ObtenerVencidasParaActualizarAsync(
        ...
        public async Task<IList<Auction>> ObtenerProgramadasParaProcesarAsync(
            DateTime ahora,
            CancellationToken cancellationToken)
        {
            return await _context.Subastas
